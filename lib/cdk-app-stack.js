...
class CdkAppStack extends cdk.Stack {
    ...
    */
    ...
    constructor(scope, id, props) {
        ...
        const bucket = new s3.Bucket(this, imageBucket, { removalPolicy: cdk.RemovalPolicy.DESTROY });
        new cdk.CfnOutput(this, "Bucket", { value: bucket.bucketName });


        const role = new iam.Role(this, "cdk-rekn-lambda-role", { assumedBy: new iam.ServicePrincipal("lambda.amazonaws.com") });
        role.addToPolicy(
        ...
        const table = new dynamodb.Table(this, "cdk-rekn-image-table", { partitionKey: { name: "Image", type: dynamodb.AttributeType.STRING }, removalPolicy: cdk.RemovalPolicy.DESTROY });
